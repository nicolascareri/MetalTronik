...
@Component({
  ...
  templateUrl: './indicadores-correctivos.component.html',
  styleUrls: ['./indicadores-correctivos.component.scss']
})

export class IndicadoresCorrectivosComponent implements OnInit {
