...
public interface MantenimientoCorrectivoRepository extends JpaRepository<MantenimientoCorrectivo, Integer> {
    ...
    @Query("SELECT man.maquina.maquina_cod, count(man), man.fechaFin, man.fechainicio from MantenimientoCorrectivo man group by man.maquina.maquina_cod, man.fechaFin, man.fechainicio order by man.fechaFin")
