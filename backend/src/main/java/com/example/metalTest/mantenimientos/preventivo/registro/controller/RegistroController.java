package com.example.metalTest.mantenimientos.preventivo.registro.controller;

import com.example.metalTest.apiError.exception.ValidateFieldException;
import com.example.metalTest.mantenimientos.preventivo.registro.controller.request.RegistroRequest;
import com.example.metalTest.mantenimientos.preventivo.registro.controller.response.RegistroResponse;
import com.example.metalTest.mantenimientos.preventivo.registro.controller.response.RegistroResponseParaListado;
import com.example.metalTest.mantenimientos.preventivo.registro.mapper.RegistroMapper;
