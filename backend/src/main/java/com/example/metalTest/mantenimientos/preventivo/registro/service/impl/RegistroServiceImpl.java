...
package com.example.metalTest.mantenimientos.preventivo.registro.service.impl;

import com.example.metalTest.apiError.exception.ValidateFieldException;
import com.example.metalTest.common.validator.RepositoryValidator;
import com.example.metalTest.mantenimientos.preventivo.registro.controller.request.RegistroRequest;
import com.example.metalTest.mantenimientos.preventivo.registro.domain.Registro;
import com.example.metalTest.mantenimientos.preventivo.registro.repository.RegistroRepository;
import com.example.metalTest.mantenimientos.preventivo.registro.service.RegistroService;
...
public class RegistroServiceImpl implements RegistroService {
    ...
    RepositoryValidator<Registro> repositoryValidator = new RepositoryValidator<Registro>();
    ...
    public Registro update(RegistroRequest registroRequest, Integer id) throws ValidateFieldException {
        Registro registro = repositoryValidator.getObject(registroRepository, id);
    ...
    public Registro getById(Integer id) throws ValidateFieldException {
        return repositoryValidator.getObject(registroRepository, id);
    }
